...
public class Setting extends AppCompatActivity {
    ...
    private void showObjectiveDialog(Context context) {
        View dialogView = LayoutInflater.from(context).inflate(R.layout.dialog_objective, null);
        AlertDialog.Builder dialogBuilder = new AlertDialog.Builder(context)
                .setView(dialogView)
                .setTitle("Select Objective Steps");

        NumberPicker objectiveSeekBar = dialogView.findViewById(R.id.stepsPicker);
